...
import { usePortalUsers, useUserRoles, useAssignRole } from "@/features/user/model/useUserManagement";
import { useRoles } from "@/features/role/model/useRoles";
import { useAuditLogs } from "@/features/auditLog/model/useAuditLogs";
...
export default function PortalSettingsPage({ portalSlug }: { portalSlug: string }) {
