...
function FeatureCard({ icon: Icon, title, description }: { icon: React.ElementType; title: string; description: string }) {
  return (
    <Card.Root p="6" h="full" borderWidth="1px" borderColor="gray.200" bg="white" _hover={{ shadow: "lg", borderColor: "blue.300", transform: "translateY(-2px)" }} transition="all 0.2s">
      <Card.Body>
        ...
        <Container maxW="1200px">
          <Stack gap="16">
            <Box textAlign="center" maxW="640px" mx="auto">
              ...
              <Heading size="3xl" mb="4" letterSpacing="-0.02em">
                Три шага до первого проекта
              </Heading>
            </Box>

            <SimpleGrid columns={{ base: 1, md: 3 }} gap="8">
              {[
                { label: "Создайте пространство", desc: "Портал — это отдельная экосистема для клиента или направления бизнеса." },
                { label: "Пригласите команду", desc: "Назначайте роли: владелец, менеджер, исполнитель, клиент." },
                { label: "Ведите работу", desc: "Создавайте задачи, отслеживайте бюджет и общайтесь в чатах." },
              ].map((step, i) => (
                <Box key={step.label} position="relative">
                  <Card.Root p="8" h="full" bg="slate.50" borderWidth="1px" borderColor="gray.100">
                    <Card.Body>
                      <Box
                        w="10"
                        h="10"
